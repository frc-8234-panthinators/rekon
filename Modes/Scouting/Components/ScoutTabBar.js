...
export default function MyTabBar({ state, descriptors, navigation }) {
    ...
    return (
      <View style={{ flexDirection: 'row',backgroundColor: (Colors.tab) ,height:windowHeight * 0.095,width: windowWidth * 0.9,borderRadius:10, marginLeft: 'auto', marginRight: 'auto', justifyContent:"center",alignItems:"center" }}>
